...
int main() {
    ...
    cout << (bag1.get_size() == 0) << " ";
    cout << (bag2.get_size() == 0) << " ";

    cout << (bag1.get_count(3) == 0) << " ";

    cout << (bag1.get_capacity() == 30) << " ";
    cout << (bag2.get_capacity() == 100) << " ";
    cout << endl;
    ...
    cout << (bag1.get_size() == 5) << " ";
    cout << (bag1.get_count(3) == 2) << " ";
    cout << (bag1.get_count(4) == 3) << " ";

    bag1.erase(4);
    bag1.erase_one(3);

    cout << (bag1.get_size() == 1) << " ";
    cout << (bag1.get_count(3) == 1) << " ";
    cout << (bag1.get_count(4) == 0) << " ";

    bag1.reserve(1000);

    cout << (bag1.get_capacity() == 1000) << " ";
    cout << (bag1.get_size() == 1) << " ";
    cout << (bag1.get_count(3) == 1) << " ";
    cout << (bag1.get_count(4) == 0) << " ";
    cout << endl;
