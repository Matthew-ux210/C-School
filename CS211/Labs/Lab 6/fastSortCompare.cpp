...
int findPivot(int data[], int left, int mid, int right) {
    // NOTE that if you simply want a strategy of choosing one index,
...
void quickSortRecursive(int data[], int start, int end) {
    ...
    // NOTE: These *are* recursive calls, so count them as recursive calls!
